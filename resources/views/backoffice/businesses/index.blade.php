                ...
                <table class="table">
                    ...
                    @foreach ($businesses as $business)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('backoffice.businesses.schedules', $business->id) }}">{{$business->schedules->count()}}
                                    Schedules</a></td>
                            <td>
                                <a href="{{ route('backoffice.businesses.edit', [$business]) }}">Editar</a>
                                @if(\Auth::user()->isTeamUser())
                                    | <a href="#" onclick="confirmDeletion({{$business->id}})">Delete</a>
                                @endif
                            </td>
                        </tr>
                    @endforeach
