                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><a href="{{ route('backoffice.submissions.entries', $submission->id) }}">{{$submission->entries->count()}}
                                        Entries</a></td>
                                <td>{{$submission->confirmed?"Yes":"No"}}</td>
                                <td>{{$submission->validated?"Yes":"No"}}</td>
                                <td><a href="#" onclick="confirmValidation({{$submission->id}})">Validate</a>|<a href="#" onclick="confirmDeletion({{$submission->id}})">Delete</a></td>
                            </tr>
                            @endforeach
                        </tbody>
                    </table>
