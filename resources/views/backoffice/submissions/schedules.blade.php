    ...
    <div class="row justify-content-center">
        <div class="card">
            ...
            <div class="card-body">
                ...
                @endif
                <h2>Entry #{{$entry->id}} Schedules List</h2>
                <table class="table">
                    <thead>
                    <tr>
                        <th scope="col">#</th>
                        ...
                        <th scope="col">Open on Thursdays</th>
                    ...
                    @foreach ($entry->schedules as $schedule)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('backoffice.submissions.schedules.edit', [$entry->id, $schedule->id]) }}">Editar</a>
                                | <a href="#" onclick="confirmDeletion({{$schedule->id}})">Delete</a>
                            </td>
                        </tr>
                    @endforeach
                    </tbody>
                ...
                <form id="confirmDeletion" style="display:none;" method="POST"
                      action="{{route('backoffice.submissions.schedules.delete')}}">
                    <hr/>
                    @csrf
                    <p>Confirm the deletion of Submission Entry Schedule#<span id="confirmDeletionDisplay_id"></span>
                    </p>
